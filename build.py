...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','com.0x82.twitter.js')
	...
	f = os.path.join(cwd,'Classes','Com0x82TwitterModuleAssets.m')
	c = open(f).read()
	idx = c.find('return ')
	before = c[0:idx]
	after = """
...
ignoreFiles = ['.DS_Store','.gitignore','libTitanium.a','titanium.jar','README','com.0x82.twitter.js']
